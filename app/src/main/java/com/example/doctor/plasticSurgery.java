...
public class plasticSurgery extends AppCompatActivity {
    ...
    String[]subtitle = {"جراحة التجميل", "جراحة التجميل", "جراحة التجميل", "جراحة التجميل", "جراحة التجميل", "جراحة التجميل", "جراحة التجميل","جراحة التجميل","جراحة التجميل","جراحة التجميل","جراحة التجميل","جراحة التجميل"};
